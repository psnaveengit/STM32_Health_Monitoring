...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  UART_SEND_TXT(&huart2, "ADC = ", 0);
	  UART_SEND_FLT(&huart2, channel1, 1);
	  HAL_ADC_Stop(&hadc1);
...
static void MX_ADC1_Init(void)
{
  ...
  //ADC_ChannelConfTypeDef sConfig = {0}; //COMMENTED OUT
  ...
  */
  ...
  hadc1.Init.NbrOfConversion = 1; //change from 2 to 1
